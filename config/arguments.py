...
def parse_args():
    ...
    args.add_argument('--test_csv_path', default=None, type=str)        # the path to the csv file containing the metadata of each slice for testing (if needed)
    ...
    args.add_argument('--num_class', default=2, type=int)   # for binary classification:2
    args.add_argument('--axis', default=2, choices=[0,1,2], type=int)    # axis of the slices -> 0: Sagittal, 1: Coronal, 2: Axial
    args.add_argument('--modalities', nargs='+', type=str, help="List of modalities for late fusion") # e.g. ['Clinical', 'T1_bias', 'T1c_bias', 'T2_bias', 'FLAIR_bias']
